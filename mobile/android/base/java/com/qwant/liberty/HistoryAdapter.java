...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryViewHolder> {
    ...
    static class HistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        HistoryViewHolder(LinearLayout v) {
            ...
            item_logo.setImageResource(R.drawable.qwant_icon_clock);
        }
    }
    ...
    @NonNull @Override public HistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int view_type) {
        LinearLayout item_layout = (LinearLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.qwant_widget_suggestlist_item, parent, false);
        return new HistoryViewHolder(item_layout);
    }

    @Override public void onBindViewHolder(@NonNull HistoryViewHolder historyViewHolder, int i) {
